...
{
    /// <summary>
    /// Validador para el DTO de actualización de consultorio
    /// </summary>
    public class ConsultorioUpdateDtoValidator : AbstractValidator<ConsultorioUpdateDto>
    {
        public ConsultorioUpdateDtoValidator()
        {
