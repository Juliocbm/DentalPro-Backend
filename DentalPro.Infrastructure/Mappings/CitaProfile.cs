...
public class CitaProfile : Profile
{
    public CitaProfile()
    {
        ...
        CreateMap<Cita, CitaDto>()
            ...
            .ForMember(dest => dest.NombreDoctor, opt => opt.MapFrom(src => src.Usuario.Nombre));
        ...
        CreateMap<Cita, CitaDetailDto>()
            ...
            .ForMember(dest => dest.NombreCompletoDoctor, opt => opt.MapFrom(src => src.Usuario.Nombre))
            .ForMember(dest => dest.EmailDoctor, opt => opt.MapFrom(src => src.Usuario.Correo))
